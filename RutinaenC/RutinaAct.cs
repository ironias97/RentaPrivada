...
namespace RutinaenC
{
    ...
    class RutinaAct
    {
        ...
        public List<beResultados> RutinaPension(
            ...
            List<beTasasPromedio> ModelTasPro, List<beCurvaTasas> ModelTasCurva)
        {
            ...
            foreach (var item in ModelCot)
            {
                ...
                {
                    case "1":
                        TipRen = "I"; // RENTA VITALICIA FAMILIAR
                        break;
                    case "2":
                        TipRen = "D"; // RENTA VITALICIA FAMILIAR DIFERIDA
                        break;
                    case "3":
                        TipRen = "M"; // RENTA MIXTA
                        break;
                    case "5":
                        TipRen = "C"; // RENTA COMBINADA
                        break;
                    case "6":
                        TipRen = "E"; // RENTA VITALICIA ESCALONADA
                        break;
                ...
                {
                    case "08":
                        TipPen = "S"; // SOBREVIVENCIA
                        break;
                    case "07":
                        TipPen = "P"; // INVALIDEZ PARCIAL
                        break;
                    case "06":
                        TipPen = "I"; // INVALIDEZ TOTAL
                        break;
                    case "05":
                        TipPen = "V"; // JUBILACION ANTICIPADA
                        break;
                    case "04":
                        TipPen = "V"; // JUBILACION LEGAL
                        break;
                }
                            ...
                            try
                            {
                                for (i = 0; i <= limite1; i++)
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        ////280519
                                        //en caso de roolback descmentar 
